...
// End Cross Module References
	...
	UFunction* Z_Construct_UFunction_ALocalGovActor_localGovSendTagUpdate()
	{
		...
		if (!ReturnFunction)
		{
			static const UE4CodeGen_Private::FArrayPropertyParams NewProp_BoostVals = { UE4CodeGen_Private::EPropertyClass::Array, "BoostVals", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(LocalGovActor_eventlocalGovSendTagUpdate_Parms, BoostVals), METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_BoostVals_Inner = { UE4CodeGen_Private::EPropertyClass::Float, "BoostVals", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000000000000, 1, nullptr, 0, METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_BoostVals,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_BoostVals_Inner,
			};
#if WITH_METADATA
	...
	UClass* Z_Construct_UClass_ALocalGovActor()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_ALocalGovActor_localGovSendTagUpdate, "localGovSendTagUpdate" }, // 1748306715
	...
	IMPLEMENT_CLASS(ALocalGovActor, 1762915772);
